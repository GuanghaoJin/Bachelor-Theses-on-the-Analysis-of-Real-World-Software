...
int main() {
    ...
    __CPROVER_array_set(str1, __CPROVER_nondet_char());
    __CPROVER_array_set(str2, __CPROVER_nondet_char());

    str1[len - 1] = '\0';
    str2[len - 1] = '\0';

    if (safe_memcmp(str1, str2, len)) {
        __CPROVER_assert(strcmp(str1, str2) == 0, "Strings should be identical");
    } else {
        __CPROVER_assert(strcmp(str1, str2) != 0, "Strings should be different");
    }
