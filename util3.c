...
int main() {
    ...
    char *test_str1 = malloc(sizeof(char) * (strlen1));
    ...
    char *test_str2 = malloc(sizeof(char) * (strlen2));
    ...
    __CPROVER_assert(result == (strncmp(test_str1, test_str2,len) == 0), "safe_memcmp should return true if stringsare equal in the given length");
